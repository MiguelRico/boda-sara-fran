export default function RsvpStatusDialog({ popup, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#2f2a25]/30 px-5 backdrop-blur-sm">
      <div className="premium-card max-w-md text-center">
        <p className="section-eyebrow mb-3">
          {popup.type === "success" ? "Confirmado" : "Aviso"}
        </p>

        <h2 className="font-serif text-3xl text-[#2f2a25]">{popup.title}</h2>
