...
export default function Hero() {
  ...
  return (
    <CinematicSection id="init" className="surface-soft" reveal={false}>
      ...
      >
        <StaggeredRevealItem index={0} isVisible={heroInView}>
          <p className="section-eyebrow">22 de Agosto de 2026</p>
        </StaggeredRevealItem>

        <StaggeredRevealItem index={1} isVisible={heroInView}>
          <h1 className="hero-title">
            Sara <span className="mx-2">&</span> Fran
          </h1>
        </StaggeredRevealItem>

        <StaggeredRevealItem index={2} isVisible={heroInView}>
          <div className="mt-8 mb-2 h-px w-20 bg-[#d8c1ad]" />
        </StaggeredRevealItem>

        <StaggeredRevealItem index={3} isVisible={heroInView}>
        ...
        <StaggeredRevealItem index={4} isVisible={heroInView}>
        ...
        <StaggeredRevealItem index={5} isVisible={heroInView}>
